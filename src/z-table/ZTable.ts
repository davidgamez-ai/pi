// Adapted from: https://github.com/arjanfrans/node-ztable
const ZTABLE:any =
    {
...
export function getPercentile(zscore:number):number {
    if (isNaN(zscore)) {
    ...
    var z100:number = isNaN(xZscore) ? Math.abs(zscore) : xZscore;
    var z10:string = yZscore === 0 ? '0.0' : yZscore.toFixed(1);
    var col:number = ZTABLE.z.indexOf(z100);
