...
export class DataProcessor {
    ...
    static async extractMicrosoftData() {
        const dailyUrl = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=MSFT&outputsize=full&apikey=" + ALPHA_VANTAGE_API_KEY;
        const weeklyUrl = "https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY_ADJUSTED&symbol=MSFT&outputsize=full&apikey=" + ALPHA_VANTAGE_API_KEY;
